...
[group('CI/CD')]
ghvars repo="j340m3/sops-generator":
...
[group('CI/CD')]
ghsecrets repo="j340m3/sops-generator":
...
[group('conda package')]
conda-lint-fix package="sops-generator":
...
[group('conda package')]
conda-type package="sops-generator":
...
[group('conda package')]
conda-check package="sops-generator": (conda-lint package) (conda-type package) (conda-test package)
...
[group('template')]
template-init:
    echo "Use: nix --accept-flake-config run github:juspay/omnix -- init github:j340m3/sops-generator -o new-python-project"
...
[group('release')]
test-package-release package-name="sops-generator" branch="main":
