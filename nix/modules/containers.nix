...
}:
{
  perSystem =
    ...
    let
      ...
      defaultPythonEnv = defaultPythonSet.mkVirtualEnv "sops-generator-env" baseWorkspace.deps.default;
      defaultEditablePythonEnv = defaultEditablePythonSet.mkVirtualEnv "sops-generator-editable-env" baseWorkspace.deps.all;
    ...
    in
    {
      ...
      legacyPackages = lib.optionalAttrs isLinux {
        sops-generatorManifest = inputs.flocken.legacyPackages.${system}.mkDockerManifest {
          inherit version;
          github = {
            enable = true;
            enableRegistry = true;
        ...
        sops-generator-devManifest = inputs.flocken.legacyPackages.${system}.mkDockerManifest {
          inherit version;
          github = {
            enable = true;
            enableRegistry = true;
