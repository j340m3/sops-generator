      ...
      mkEditablePythonSet =
        ...
        (mkPythonSet python).overrideScope (
          lib.composeManyExtensions [
            ...
            (final: prev: {
              # sops-generator = prev.sops-generator.overrideAttrs (old: {
              #   src = lib.fileset.toSource {
              #     root = old.src;
              #     fileset = lib.fileset.unions [
              #       (old.src + "packages/sops-generator/pyproject.toml")
              #       (old.src + "packages/sops-generator/README.md")
              #       (old.src + "packages/sops-generator/src/sops_generator/__init__.py")
              #     ];
              #   };
